        ...
        <div className="flex items-start gap-4 sm:gap-5">
          ...
          {kennel.logoUrl ? (
            ...
            <img
              ...
              className="h-20 w-20 rounded-xl object-contain bg-white dark:bg-background ring-2 ring-white dark:ring-background shadow-md sm:h-24 sm:w-24"
            />
          ) : (
            <div
              className="flex h-20 w-20 items-center justify-center rounded-xl text-xl font-bold text-white shadow-md ring-2 ring-white/80 dark:ring-background/80 sm:h-24 sm:w-24 sm:text-2xl"
