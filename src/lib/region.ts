...
export const REGION_SEED_DATA: RegionSeedRecord[] = [
  ...
  },
  {
    ...
    centroidLat: 52.77,
    centroidLng: -1.21,
    aliases: ["East Midlands, England", "Derby"],
  },
  {
    name: "Hertfordshire",
    country: "UK",
  ...
  },
  {
    ...
    centroidLat: 51.9007,
    centroidLng: -1.1522,
    aliases: ["Bicester, England", "Oxfordshire"],
  },
  {
    name: "Cornwall",
    country: "UK",
  ...
  //    intermediate, mirroring Cambodia/Vietnam/Nepal). Rose palette — distinct
  //    from every Asian neighbour (Vietnam=cyan, Nepal=violet, Cambodia=purple,
  //    Thailand=orange, Malaysia=green, Indonesia=teal, Taiwan=sky,
  //    Singapore/HK/Japan=red, Philippines=fuchsia); rose's other owners (UK,
  //    US-east) are nowhere near it on the map. ──
  {
    name: "Sri Lanka",
    country: "Sri Lanka",
    level: "COUNTRY",
  ...
  // ── Australia Phase 1b: NSW + SA + QLD ──
  {
    ...
    centroidLat: -32.16,
    centroidLng: 147.02,
    aliases: ["NSW", "New South Wales, Australia"],
  },
  {
    ...
    abbrev: "SAU", // SA collides with US South-East abbrevs/region keys; use SAU
    colorClasses: "bg-yellow-100 text-yellow-700",
    pinColor: "#854d0e",
    centroidLat: -30.05,
    centroidLng: 135.76,
    aliases: ["SA", "South Australia, Australia"],
  },
  {
    name: "Queensland",
    country: "Australia",
    ...
    centroidLat: -22.49,
    centroidLng: 144.43,
    aliases: ["QLD", "Queensland, Australia"],
  },
  {
    name: "Sydney, NSW",
    country: "Australia",
  ...
  },
  {
    ...
    pinColor: "#a16207",
    centroidLat: -34.9285,
    centroidLng: 138.6007,
    aliases: ["Adelaide", "Adelaide, Australia"],
  },
  {
    name: "Gold Coast, QLD",
    country: "Australia",
    ...
    pinColor: "#854d0e",
    centroidLat: -28.0167,
    centroidLng: 153.4000,
    aliases: ["Gold Coast", "Gold Coast, Australia"],
  },
...
const COUNTRY_INFERENCE_RULES: ReadonlyArray<readonly [RegExp, string]> = [
  ...
  // Nepal — country + the two unambiguous Nepali cities. Bare "himalayan" is
