    ...
    // --- El Paso (1 Google Calendar) ---
    {
      ...
      config: {
        ...
        skipPatterns: [
          ...
          String.raw`^St\.?\s+Patrick`,
          String.raw`^Tax\s+Day\b`,
          String.raw`^Cinco\s+de\s+Mayo\b`,
          String.raw`^Mother'?s\s+Day\b`,
          String.raw`^Father'?s\s+Day\b`,
          String.raw`^Flag\s+Day\b`,
        ],
      },
      kennelCodes: ["bjh3"],
    },
