export const KENNEL_ALIASES: Record<string, string[]> = {
    ...
    "nawwh3": ["NAWW", "NAWWH3", "NAWW Hash", "New Amsterdam Weekend Wankers", "New Amsterdam Winter Wednesday", "Weekend Wankers"],
    "nah3": ["New Amsterdam", "NAH3", "NASS", "NASS H3", "NASSH3", "New Amsterdam Hash", "New Amsterdam Summer Sundays"],
    ...
    // Second Indonesia kennel — Bandung (BHHH2). "BHHH2" (with the 2) is free;
    // omit "BH2" (→ bali-hash-2) and bare "BHHH" (→ bh4, Big Hump H3).
    ...
    // Moonshine H3 Dubai (third UAE kennel; bare "MH3" omitted — global collision:
    // mh3-de=Munich, mh3-ca=Montreal, mh3-mn=Minneapolis, mia-h3=Miami, Madrid/Memphis/Morgantown/Manila)
