...
export const KENNELS: KennelSeed[] = [
    ...
    },
    {
      ...
      foundedYear: 1980,
      description: "Founded in 1980 on the mainland side of Penang, Butterworth H3 runs weekly Saturday trails through Seberang Perai and the mainland Penang hinterland.",
