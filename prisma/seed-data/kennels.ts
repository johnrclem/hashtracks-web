...
export const KENNELS: KennelSeed[] = [
    ...
    // --- Syracuse ---
    {
      ...
      logoUrl: "https://www.soh4.com/wp-content/uploads/2016/07/pint.png",
    ...
    // --- Capital District ---
    {
      ...
      logoUrl: "https://www.hmhhh.com/hhlogo.gif",
    ...
    // --- Ithaca ---
    {
      ...
      facebookUrl: "https://www.facebook.com/IthacaH3/",
    ...
    },
    {
      ...
      scheduleNotes: "Trails usually start between noon and 1pm on weekends.",
      contactEmail: "hareraisernh3@gmail.com",
      foundedYear: 2010, hashCash: "$7",
      logoUrl: "/kennel-logos/nbh3.jpg",
      description: "We usually charge $7 per Trail to offset expenses, which are mostly due to BEER. Pay only for the trails you participate in. We hash in and around Worcester, MA USA. Trails usually start between noon and 1pm on the weekend.",
    },
    {
    ...
    { kennelCode: "asssh3", shortName: "ASSSH3", fullName: "All Seasons Summit Shiggy H3", region: "North NJ" },
    {
      ...
      foundedYear: 2014,
      description: "Active weekly kennel in North NJ (north of I-78). Runs flip from Thursdays in summer to Wednesdays in winter. Founded in 2014 by Twatever; parented by Rome H3. Hotline: 973.627.2575.",
    },
    {
    ...
    },
    {
      ...
      contactEmail: "ichy.h3@gmail.com",
      gm: "Penis Fly Trap, Nightmare on Ohm Street, and Co.",
      hareRaiser: "FUCK, Enterthighs, and Co.",
      hashCash: "$5 (virgins free)",
    ...
    },
    {
      ...
      logoUrl: "https://lh3.googleusercontent.com/sitesv/AA5AbUAJFK5ePxlucWAWPzBZSZdG9Bi8IsU7wTnuVqu9MHmQ1moC-Gx9-XwEnbisyI7B8FO2lkdgoaIe0ccboIjpSDvUBvt09DNjEHkg7s3SCzhx3X3Gnb_E2Ho7FBlwi6hxTjeQX2cPQeH588oUBRcXONsQwFIb3_dUf8RgImslXuYDlLRXWSzJmbgiRc10nDGmU-haIiQJbUpqGNiEmr1vzcO5RYvJieMT-cQI=w1280",
      scheduleFrequency: "Monthly", scheduleNotes: "Friday/Saturday on or near the full moon",
      contactEmail: "dcfullmoonh3@gmail.com",
      signatureEvent: "Tour Duh Hash",
      description: "Monthly hash on or near the full moon — the 'Gathering of the Clans' hosted by rotating DC-area kennels.",
    },
    {
    ...
    // Los Angeles Area
    {
      ...
      instagramHandle: "losangelesh3",
      logoUrl: "https://hash.beer/wp-content/uploads/2026/03/lah3.hare_.gif",
      scheduleDayOfWeek: "Saturday", scheduleFrequency: "Weekly",
      scheduleNotes: "Saturdays — start time varies, typically 1–3 PM.",
      hashCash: "$5", foundedYear: 1977,
      description: "LA's flagship Saturday afternoon hash, running every Saturday somewhere in LA county since 1977.",
    ...
    // San Diego Area
    {
      ...
      facebookUrl: "https://www.facebook.com/SanDiegoHashHouseHarriers",
      contactEmail: "webmaster@sdh3.com",
      scheduleDayOfWeek: "Friday", scheduleTime: "6:30 PM", scheduleFrequency: "Biweekly",
      scheduleNotes: "Every other Friday 6:30 PM and every other Sunday 10:00 AM",
      foundedYear: 1986,
      hashCash: "$10",
      logoUrl: "https://sdh3.com/site_images/sdh3-logo-thm.gif",
      description: "San Diego's flagship kennel. Hosts the sdh3.com directory covering 15+ San Diego area kennels.",
    ...
    },
    {
      ...
      hashCash: "$8", foundedYear: 1990,
      description: "San Diego biweekly Friday evening hash.",
      latitude: 32.72, longitude: -117.16,
    },
    {
    ...
    },
    {
      ...
      facebookUrl: "https://www.facebook.com/groups/218044601349",
      twitterHandle: "oldcoulsdonhhh",
      contactEmail: "oldcoulsdonhhh@gmail.com",
      foundedYear: 1984, founder: "Robin Masefield",
    ...
    // ===== UK — NORFOLK =====
    {
      ...
      instagramHandle: "norfolkh3",
      mailingListUrl: "https://groups.google.com/g/norfolkhhh",
      contactEmail: "norfolkhhh+subscribe@googlegroups.com",
      ...
      hashCash: "£2.50 after first run", foundedYear: 1984,
      gm: "Lobotomy", hareRaiser: "Woolly Jumper",
      logoUrl: "https://norfolkh3.co.uk/wp-content/uploads/2024/07/foot-removebg-preview.png?w=500",
    ...
    },
    {
      ...
      logoUrl: "https://ironcityh3.com/wp-content/uploads/2026/01/logo.jpg",
      facebookUrl: "https://www.facebook.com/groups/243332137219546/",
      instagramHandle: "ironcityh3running",
      foundedYear: 1980,
      scheduleDayOfWeek: "Friday", scheduleFrequency: "Weekly", scheduleTime: "6:30 PM",
      description: "Weekly Friday evening hash in Pittsburgh.",
      latitude: 40.44, longitude: -79.99,
    },
    // --- State College ---
    {
    ...
    },
    {
      ...
      hashCash: "$1", foundedYear: 2022,
      description: "Debauchery by moonlight done on the fortnight — biweekly Wednesday evening hash in the Triangle area.",
      latitude: 35.78, longitude: -78.64,
    },
    // --- Charlotte ---
    {
    ...
    // --- Austin ---
    {
      ...
      logoUrl: "https://austinh3.org/wp-content/uploads/2016/11/AustinH3Logo.gif",
    ...
    },
    {
      ...
      website: "https://www.kawh3.com",
      logoUrl: "https://www.kawh3.com/uploads/3/1/7/9/31794437/editor/solokaw.png",
      facebookUrl: "https://www.facebook.com/KeepAustinWeirdH3",
      instagramHandle: "kaw.h3",
      twitterHandle: "KAW_H3",
      contactEmail: "keepaustinweirdh3@gmail.com",
      hashCash: "$5",
      foundedYear: 2014,
      scheduleDayOfWeek: "Thursday", scheduleTime: "6:30 PM", scheduleFrequency: "Weekly",
      description: "Keep Austin Weird! H3 — Austin's weirdest drinking club with a running problem. Themed Thursday-night trails since 2014.",
      latitude: 30.27, longitude: -97.74,
    },
    // --- Houston ---
    {
      ...
      foundedYear: 1979,
      scheduleDayOfWeek: "Sunday", scheduleTime: "3:00 PM", scheduleFrequency: "Weekly",
      description: "Houston Hash House Harriers (H4) — running, beer, and friends since 1979. Sunday afternoons on trail through the streets, mud, and shiggy of Houston.",
    ...
    // --- Florida Keys ---
    {
      ...
      logoUrl: "https://keywesthash.com/uploads/3/5/0/4/35048257/kwh3-happi-coat-logo_orig.jpg",
    ...
    // --- Myrtle Beach ---
    {
      ...
      instagramHandle: "grandstrandmyrtlebeachh3",
      contactEmail: "grandstrandhashcash@gmail.com",
      foundedYear: 2018,
    ...
    // --- Portland ---
    {
      ...
      facebookUrl: "https://www.facebook.com/nonameh3.onon/",
      instagramHandle: "no_name_hash",
      twitterHandle: "NoNameH3_OnOn",
      contactEmail: "NoNameH3.OnOn@gmail.com",
      scheduleDayOfWeek: "Thursday", scheduleTime: "6:45 PM", scheduleFrequency: "Weekly",
      hashCash: "$5",
    ...
    },
    {
      ...
      contactEmail: "NoBallsH3@gmail.com",
      ...
      logoUrl: "https://wh3.org/img/icons/NBH3.png",
      description: "All-women's Seattle kennel founded 1989 by Captain Crash and Slo Mo. Low-key hashing on the last Wednesday night of each month — fun, wine, and booze.",
      latitude: 47.61, longitude: -122.33,
    },
    {
    ...
    },
    {
      ...
      website: "https://wh3.org",
      facebookUrl: "https://www.facebook.com/groups/WaHHH",
      mailingListUrl: "https://groups.google.com/g/WaH3",
      contactEmail: "SeaMonH3@googlegroups.com",
      paymentLink: "https://www.paypal.com/paypalme/seamonh3",
      hashCash: "$5 cash or PayPal to @SeaMonH3",
      scheduleDayOfWeek: "Monday", scheduleTime: "7:00 PM", scheduleFrequency: "Weekly",
      foundedYear: 2015,
      logoUrl: "https://wh3.org/img/icons/SeaMonH3.png",
    ...
    },
    {
      ...
      website: "https://www.phoenixhhh.org",
      logoUrl: "https://www.phoenixhhh.org/wp-content/uploads/2013/10/Hump_Logo_150x150.jpg",
      hashCash: "$1",
      foundedYear: 2006,
      scheduleDayOfWeek: "Wednesday", scheduleTime: "6:30 PM", scheduleFrequency: "Biweekly",
    ...
    // Tucson
    {
      ...
      logoUrl: "https://tucsonhash.com/sites/default/files/jHavelina.gif",
    ...
    },
    {
      ...
      website: "https://tucsonhash.com",
      scheduleDayOfWeek: "Wednesday", scheduleTime: "7:00 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "Pick-Up Hash — the hare is chosen at the start, not pre-announced. A-A (out-and-back) trails. Bring a vessel for sharing beer on trail.",
      hashCash: "$5",
      description: "Tucson weekly Wednesday evening hash. A-A, 3-5 mile trails.",
      latitude: 32.22, longitude: -110.97,
    },
    {
    ...
    },
    {
      ...
      scheduleNotes: "Manuwahi (no cost) — bring your own beverages and pupus.",
      hashCash: "Free (BYOB)", foundedYear: 1978,
      description: "Hawaii's first Hash House Harriers kennel, running on Tuesday evenings since March 16, 1978. Manuwahi (no cost) hash — bring your own beverages and pupus. From the Hee Hing Chop Suey shop in Kapahulu to today's Run #2300+, the H5 is the granddaddy of Hawaii hashing.",
      latitude: 21.31, longitude: -157.86,
    },
    {
    ...
    },
    {
      ...
      scheduleDayOfWeek: "Saturday", scheduleTime: "2:00 PM", scheduleFrequency: "Weekly",
      foundedYear: 1984,
      logoUrl: "https://static.wixstatic.com/media/b14dad_a13aa9ca097c464e8ea06c7a843d4172~mv2.png",
    ...
    },
    {
      ...
      contactEmail: "run4h@yahoo.com",
      scheduleDayOfWeek: "Sunday", scheduleFrequency: "Monthly",
      scheduleNotes: "Once a month, typically on a Sunday — occasionally on a Saturday.",
    ...
    },
    {
      ...
      scheduleDayOfWeek: "Sunday", scheduleTime: "3:00 PM", scheduleFrequency: "Monthly",
      scheduleNotes: "Watch the kennel's Facebook group or the run notice on the website for the meet spot.",
      foundedYear: 1996,
    ...
    // ── Louisiana: New Orleans ──
    {
      ...
      contactName: "Lefty Loosey",
      logoUrl: "/kennel-logos/noh3.png",
      scheduleFrequency: "Weekly",
    ...
    // ── Tennessee: Memphis ──
    {
      ...
      logoUrl: "/kennel-logos/mh3-tn.png",
      scheduleFrequency: "Weekly",
      scheduleNotes: "Saturday trails + Thursday drinking practice + monthly Moonlight trail",
      hashCash: "$5",
      foundedYear: 1982,
      founder: "'Barnacle Bill' Butler & Chris 'Flip Flop' Stovall",
      description: "Memphis' primary hash kennel since 1982. Saturday afternoon trails, Thursday drinking practice, and first-Friday moonlight trails. Home of the annual Dead Elvis celebration (since 1993). Hotline: 901-818-9732 option 3.",
    ...
    // ── Missouri: Kansas City ──
    {
      ...
      logoUrl: "https://kansascityh3.com/wp-content/uploads/2017/02/cropped-feet.jpg",
      facebookUrl: "https://www.facebook.com/KansasCityH3",
      hashCash: "$5",
      // Approximate; derived from run-number archaeology (KCH3 #1385 in May 2018 → ~late 1991 founding).
      foundedYear: 1992,
      scheduleDayOfWeek: "Saturday", scheduleTime: "2:00 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "Saturdays 2 PM (regular); Wednesdays 6 PM in summer; Full Moon hashes 6 PM in winter. Mature adults only.",
    ...
    // ── Netherlands: The Hague ──
    {
      ...
      logoUrl: "https://haguehash.nl/wp-content/uploads/2023/05/HagueLogoGreen.png",
    ...
    },
    {
      ...
      logoUrl: "https://www.hash.se/images/common/app-icon-round-100.png",
      scheduleDayOfWeek: "Saturday", scheduleTime: "3:00 PM", scheduleFrequency: "Biweekly",
      foundedYear: 1986,
    ...
    // ── Wisconsin: Madison ──
    {
      ...
      logoUrl: "https://madisonh3.com/wp-content/uploads/2015/01/madisonh3.jpg",
      facebookUrl: "https://www.facebook.com/madisonHHH",
      contactEmail: "hare@madisonh3.com",
      scheduleDayOfWeek: "Saturday", scheduleFrequency: "Weekly",
    ...
    // ── Canada: Ontario — Toronto ──
    {
      ...
      logoUrl: "/kennel-logos/hogtownh3.png",
      facebookUrl: "https://www.facebook.com/groups/236214779728465",
      instagramHandle: "hogtownhashes",
      contactEmail: "hogtownhashes@gmail.com",
      foundedYear: 1987,
      scheduleFrequency: "Biweekly",
      scheduleNotes: "Biweekly Saturday + TWAT Thursday + Hogans Friday. Walkers and non-drinkers welcome.",
      hashCash: "$10",
    ...
    // ── Norway: Oslo ──
    {
      ...
      foundedYear: 1989, founder: "Ahluetta and Nye Hughes",
      logoUrl: "https://www.oh3.no/local/images/oh3/oh3-logo-2024-troll-color-d.png",
      contactEmail: "onsec@oh3.no",
      hashCash: "kr. 40 (without food) / kr. 70 (with food)",
      gm: "Kaya Kwanga", hareRaiser: "Buzz Lightyear",
      scheduleDayOfWeek: "Monday", scheduleTime: "6:30 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "Monday (summer) 18:30; Saturday (winter) 14:30",
    ...
    // ── Alabama ──
    {
      ...
      contactEmail: "buttler@mutharuckerh3.org",
      scheduleDayOfWeek: "Saturday",
      scheduleFrequency: "Biweekly",
      scheduleNotes: "Approximately 2 Saturday afternoons per month, plus a full-moon nighttime hash",
      hashCash: "$5", foundedYear: 2010,
      logoUrl: "/kennel-logos/mrh3.png",
    ...
    },
    {
      ...
      website: "https://gch3.com",
      logoUrl: "https://gch3.com/wp-content/uploads/2025/01/onon.png",
    ...
    },
    {
      ...
      logoUrl: "https://indyhhh.com/2_0/wp-content/uploads/2015/08/Indyscentfoot.png",
      facebookUrl: "https://www.facebook.com/groups/123463087681602/",
      twitterHandle: "indyhhh",
      foundedYear: 1999,
    ...
    // ── West Virginia: Morgantown ──
    {
      ...
      scheduleFrequency: "Weekly",
      scheduleRules: [
        { rrule: "FREQ=WEEKLY;BYDAY=SA", displayOrder: 0, notes: "Weekend day varies between Saturday and Sunday" },
        { rrule: "FREQ=WEEKLY;BYDAY=SU", displayOrder: 1, notes: "Weekend day varies between Saturday and Sunday" },
      ],
    ...
    // ── Singapore ──
    {
      ...
      logoUrl: "https://static.wixstatic.com/media/e9a490_7d00ccf591844caa9e003aa937ca438b~mv2.png",
    ...
    },
    {
      ...
      logoUrl: "/kennel-logos/lch3.jpg",
      facebookUrl: "https://www.facebook.com/groups/lioncityhash/",
      contactEmail: "lch3.sec@gmail.com",
    ...
    },
    {
      ...
      logoUrl: "https://kampong.hash.org.sg/khhhlogo.jpg",
      ...
      scheduleFrequency: "Monthly",
      scheduleTime: "5:30 PM",
      scheduleNotes: "Once a month — typically the 3rd Saturday at 5:30 PM. Mixed kennel, 18+. Hash cash S$20. Next run details posted on the website front page.",
    ...
    },
    {
      ...
      scheduleNotes: "Alternate Sundays at 5 PM, mixed. Founded February 1994. Trail registration and details posted on hashruns.org.",
      foundedYear: 1994,
      description: "Singapore's alternate-Sunday mixed hash, running since February 1994. The newest of Singapore's foot-hash chapters.",
      latitude: 1.3, longitude: 103.83,
    },
    {
    ...
    },
    {
      ...
      logoUrl: "https://hashhousehorrors.com/wp-content/uploads/2014/10/hashlogo.png",
    ...
    // hash kennel in the world — 24 years older than HHHS (Singapore, 1962).
    {
      ...
      foundedYear: 1938,
      hashCash: "RM 50 (RM 80 gazetted runs)",
      logoUrl: "/kennel-logos/motherh3.png",
    ...
    },
    {
      ...
      logoUrl: "https://kljhhh.org/wp/wp-content/uploads/2016/03/cropped-bunnyclr-192x192.gif",
      scheduleDayOfWeek: "Sunday", scheduleTime: "2:00 PM", scheduleFrequency: "Monthly",
    ...
    },
    {
      ...
      logoUrl: "https://assets.gohash.app/kennels/7/site/logo-1770815488676-601f7272-1385-4dcd-99e5-7005a6e3e933.png",
      contactEmail: "onsec@hashhouseharrietspenang.com",
      scheduleDayOfWeek: "Thursday", scheduleTime: "5:30 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "Weekly Thursday evening mixed hash, run by women.",
      foundedYear: 1972,
      description: "Founded in early February 1972 in Penang as a women-only hash; now a mixed hash but still proudly run by women. One of the oldest Harriets kennels in the world and the senior women-founded kennel in Penang. 2,700+ runs since founding.",
      latitude: 5.4164, longitude: 100.3327,
    },
    {
      ...
      scheduleNotes: "Men-only (batang) chapter based in Kelana Jaya. Run details (runsite, hare, guest fee, RSVP cutoff) are posted on the kennel blog the weekend before each run.",
      foundedYear: 1996,
    ...
    },
    {
      ...
      logoUrl: "https://topendhash.com/wp-content/uploads/2019/05/ononfoot.png",
    ...
    },
    {
      ...
      facebookUrl: "https://www.facebook.com/melctyhhh",
      instagramHandle: "melctyhhh",
      twitterHandle: "MelCtyHHH",
      contactEmail: "MELCTYHHH@hotmail.com",
      scheduleDayOfWeek: "Thursday", scheduleTime: "6:00 PM", scheduleFrequency: "Biweekly",
      scheduleNotes: "6pm every Thursday — 1st and 3rd Thursdays are hash trails, other Thursdays are 5km beer runs.",
      logoUrl: "/kennel-logos/melbourne-city-h3.jpg",
      description: "Melbourne City Hash House Harriers run for fun and post-run socialising, with public-transport-friendly trails within 10km of the Melbourne CBD.",
      latitude: -37.8136, longitude: 144.9631,
    },
    {
      kennelCode: "melbourne-bike-hash", shortName: "Melbourne Bike Hash", fullName: "Melbourne Bike Hash",
      region: "Melbourne, VIC", country: "Australia",
      website: "https://sites.google.com/view/melbournebikehhh/home",
      facebookUrl: "https://www.facebook.com/groups/Melbournebikehash/",
      contactEmail: "melbournebikehhh@gmail.com",
      scheduleFrequency: "Monthly",
      scheduleNotes: "Monthly cycle rides around greater Melbourne; ride details posted on the Facebook group.",
      hashCash: "$5",
      logoUrl: "/kennel-logos/melbourne-bike-hash.jpg",
      description: "Melbourne's bike hash — a drinking group with a cycling problem, running monthly social bike-hash rides around greater Melbourne. Hash cash is $5 for the ride and drinks.",
      latitude: -37.8136, longitude: 144.9631,
    },
    ...
    },
    {
      ...
      scheduleNotes: "Weekly Wednesday evening trails through Seberang Perai and the mainland Penang hinterland. Founded 1980 as a daughter kennel of Penang H3.",
      foundedYear: 1980,
    ...
    // ===== HONG KONG =====
    {
      ...
      logoUrl: "https://hkhash.com/wp-content/uploads/2019/08/Hashlogov3.png",
    ...
    },
    {
      ...
      contactEmail: "gunpowderplod@gmail.com", contactName: "Gunpowder Plod",
      scheduleDayOfWeek: "Wednesday", scheduleTime: "7:30 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "Also a Saturday afternoon run every couple of months.",
      hashCash: "HK$60", foundedYear: 1974,
      logoUrl: "https://n2th3.org/wp-content/uploads/2020/02/cropped-pacman-icon.jpg?w=200",
      description: "Hong Kong's Northern New Territories hash. Weekly Wednesday evening runs with 2200+ trails since founding. Blog-based trail announcements with full run details. Hash cash is HK$60 per run (HK$40 for the fairer sex); first run free.",
    ...
    },
    {
      ...
      foundedYear: 1979,
      scheduleDayOfWeek: "Wednesday", scheduleTime: "7:00 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "Meets every Wednesday. Start 6:45 for 7pm.",
      hashCash: "HK$10 run, $10 beer, $5 soft drink",
    ...
    },
    {
      ...
      region: "Hong Kong", country: "Hong Kong",
      website: "https://www.kowloonhash.com",
    ...
    },
    {
      ...
      region: "Hong Kong", country: "Hong Kong",
      scheduleDayOfWeek: "Saturday", scheduleTime: "1:00 PM", scheduleFrequency: "Monthly",
      scheduleNotes: "Monthly Saturday afternoon trails around Hong Kong. Founded 1994.",
      foundedYear: 1994,
    ...
    },
    {
      ...
      contactEmail: "chaamhash@gmail.com",
      scheduleDayOfWeek: "Saturday", scheduleTime: "4:30 PM", scheduleFrequency: "Biweekly",
      scheduleNotes: "Alternating Saturdays between Hua Hin (H2H3, founded 8 Jul 2000) and Cha-Am (CAH3, founded 13 Aug 2005).",
      hashCash: "฿100 adults / ฿50 children (+฿100 for free-flow beer)",
      foundedYear: 2000,
    ...
    },
    {
      ...
      logoUrl: "/kennel-logos/bmh3-bkk.gif",
    ...
    },
    {
      ...
      facebookUrl: "https://www.facebook.com/groups/308747049238960",
      contactEmail: "ph3.webmaster@gmail.com",
      scheduleDayOfWeek: "Monday", scheduleFrequency: "Weekly",
      scheduleTime: "3:00 PM",
      ...
      foundedYear: 1984,
      hashCash: "400 baht male / 150 baht female",
      logoUrl: "/kennel-logos/pattaya-h3.png",
    ...
    // ── South Korea (first 🇰🇷 kennel: Seoul H3) ──
    {
      ...
      foundedYear: 1972,
      hashCash: "₩10,000",
      logoUrl: "https://seoulhash.com/images/shhh_logo_120.png",
    ...
    },
    {
      ...
      scheduleFrequency: "Weekly",
      scheduleNotes: "Schedule varies — check renoh3.com for upcoming trails. Mix of Saturday and weekday runs.",
      description: "Reno's hash kennel in northern Nevada. Trail details and run schedule posted on renoh3.com.",
    ...
    },
    {
      ...
      region: "Salt Lake City, UT",
      website: "https://www.whoremanh3.com",
      logoUrl: "/kennel-logos/lds-h3.jpg",
      scheduleDayOfWeek: "Thursday", scheduleFrequency: "Weekly",
      scheduleTime: "6:00 PM",
    ...
    // ── New Zealand (Phase 1: Auckland + Christchurch + Hamilton/Waikato + Wellington founders) ──
    {
      ...
      scheduleNotes: "Weekly Monday evening runs at 6:30 PM. Camps and weekend-away events posted at christchurchhash.net.nz/events.",
      description: "Founded 12 November 1979, Christchurch's first hash kennel and the oldest South Island hash. Weekly Monday evening runs across the Canterbury region with periodic weekend-away camps.",
      latitude: -43.5321, longitude: 172.6362,
    },
    {
      kennelCode: "garden-city-h3", shortName: "GCH3", fullName: "Garden City Hash House Harriers",
      region: "Christchurch, NZ", country: "New Zealand",
    ...
    {
      kennelCode: "hibiscus-h3", shortName: "Hibiscus H3", fullName: "Hibiscus Hash House Harriers",
    ...
    {
      kennelCode: "tokoroa-h3", shortName: "Tokoroa H3", fullName: "Tokoroa Hash House Harriers",
      region: "Hamilton, NZ", country: "New Zealand",
      facebookUrl: "https://www.facebook.com/TokoroaHHH",
      foundedYear: 1983,
      scheduleFrequency: "Weekly",
    ...
    },
    {
      ...
      facebookUrl: "https://www.facebook.com/ThirstyThursdayTaniwhaH3",
      foundedYear: 2016,
      scheduleDayOfWeek: "Thursday", scheduleTime: "6:30 PM", scheduleFrequency: "Monthly",
      scheduleNotes: "2nd Thursday of every month at 6:30 PM. ~5km trails near public transport. Founded 26 May 2016.",
      description: "Wellington's monthly Thursday hash. Short urban trails (~5km) accessible by public transport, focused on inclusivity and post-run drinks.",
      latitude: -41.2866, longitude: 174.7756,
    },
    {
      kennelCode: "auckland-hussies", shortName: "Auckland Hussies", fullName: "Auckland Hash House Hussies",
      region: "Auckland, NZ", country: "New Zealand",
