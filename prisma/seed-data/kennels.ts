...
export const KENNELS: KennelSeed[] = [
    ...
    },
    {
      ...
      description: "Monthly hash on or near the full moon — the 'Gathering of the Clans' hosted by rotating DC-area kennels. Home of the annual Tour Duh Hash event series.",
    },
    {
    ...
    },
    {
      ...
      scheduleNotes: "Runs roughly once a month on a Sunday at 3:00 PM. Watch the kennel's Facebook group or the run notice on the website for the meet spot.",
      foundedYear: 1996,
    ...
    },
    {
      ...
      scheduleNotes: "Weekly Tuesday 6pm. Men-only (batang) chapter based in Kelana Jaya. Run details (runsite, hare, guest fee, RSVP cutoff) are posted on the kennel blog the weekend before each run.",
      foundedYear: 1996,
    ...
    },
    {
      ...
      scheduleDayOfWeek: "Monday", scheduleTime: "6:00 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "One of Hong Kong's oldest kennels, hashing continuously since the 1970s.",
      foundedYear: 1970,
