...
export const KENNELS: KennelSeed[] = [
    ...
    // ===== MALAYSIA Phase 2 — Historic Regional kennels =====
    {
      ...
      scheduleNotes: "Historic-kennel STATIC_SCHEDULE exception. Founded 1963, one of Malaysia's oldest hash kennels. Verified active per malaysiahash.com directory. Facebook/phone-only — no scrapeable web source.",
      foundedYear: 1963,
    ...
    },
    {
      ...
      scheduleDayOfWeek: "Saturday", scheduleTime: "5:00 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "Historic-kennel STATIC_SCHEDULE exception. Founded 1964, one of Sabah's earliest hash kennels. Verified active per malaysiahash.com directory. Facebook/phone-only — no scrapeable web source.",
      foundedYear: 1964,
    ...
    },
    {
      ...
      scheduleDayOfWeek: "Saturday", scheduleTime: "5:00 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "Historic-kennel STATIC_SCHEDULE exception. Founded 1965, one of Malaysia's oldest hash kennels. Verified active per malaysiahash.com directory. Facebook/phone-only — no scrapeable web source.",
      foundedYear: 1965,
    ...
    },
    {
      ...
      scheduleDayOfWeek: "Saturday", scheduleTime: "5:00 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "Historic-kennel STATIC_SCHEDULE exception. Founded 1969, the oldest hash kennel in Johor state. Verified active per malaysiahash.com directory. Facebook page at facebook.com/tjbhhh.",
      foundedYear: 1969,
    ...
    },
    {
      ...
      scheduleDayOfWeek: "Saturday", scheduleTime: "5:00 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "Historic-kennel STATIC_SCHEDULE exception. Founded 1980, the mainland Penang hash kennel. Verified active per malaysiahash.com directory. Facebook/phone-only — no scrapeable web source.",
      foundedYear: 1980,
    ...
    },
    {
      ...
      scheduleDayOfWeek: "Saturday", scheduleTime: "5:00 PM", scheduleFrequency: "Weekly",
      scheduleNotes: "Historic-kennel STATIC_SCHEDULE exception. Founded 1967, one of Malaysia's oldest hash kennels. Verified active per malaysiahash.com directory. Facebook/phone-only — no scrapeable web source.",
      foundedYear: 1967,
    ...
    },
    {
      ...
      scheduleNotes: "Historic-kennel STATIC_SCHEDULE exception. Facebook-only, low run number (~69). Exact cadence uncertain — at least monthly Fridays.",
    ...
    },
    {
      ...
      region: "Hong Kong", country: "Hong Kong",
      scheduleDayOfWeek: "Saturday", scheduleTime: "1:00 PM", scheduleFrequency: "Monthly",
      scheduleNotes: "Historic-kennel STATIC_SCHEDULE exception. Founded 1994, no web presence. Confirmed active via Wanchai H3 site + Google Groups.",
      foundedYear: 1994,
    ...
    },
    {
      ...
      region: "Hong Kong", country: "Hong Kong",
      scheduleDayOfWeek: "Saturday", scheduleTime: "3:00 PM", scheduleFrequency: "Monthly",
      scheduleNotes: "Historic-kennel STATIC_SCHEDULE exception. Founded 2019, Facebook-only (~220 followers). Sai Kung area.",
      foundedYear: 2019,
    ...
    // ── Nevada + Utah (US gap fill) ──
    {
      ...
      scheduleDayOfWeek: "Saturday", scheduleFrequency: "Biweekly",
      scheduleNotes: "1st/3rd/5th Saturdays. Events at lvh3.org via The Events Calendar REST API.",
