...
async function main() {
  ...
  const kennels: Array<{
    ...
    {
      kennelCode: "bobbh3", shortName: "BoBBH3", fullName: "Boston Ballbuster Hash House Harriers", region: "Boston, MA",
      scheduleDayOfWeek: "Saturday", scheduleFrequency: "Monthly",
    },
    { kennelCode: "beantown", shortName: "Beantown", fullName: "Beantown Hash House Harriers", region: "Boston, MA" },
    {
      kennelCode: "bos-moon", shortName: "Bos Moon", fullName: "Boston Moon Hash", region: "Boston, MA",
      scheduleFrequency: "Full Moon",
    },
