...
async function main() {
  ...
  const kennels: Array<{
    ...
    // --- Charleston ---
    {
      ...
      foundedYear: 1988,
      description: "Weekly Thursday evening trail runs in Charleston. Oldest kennel in South Carolina.",
    },
    {
  ...
  const kennelAliases: Record<string, string[]> = {
    ...
    "sech3": ["Secession H3", "Secession Hash", "SH3", "SHHH"],
    "palh3": ["Palmetto H3", "Palmetto Hash", "PH3"],
  ...
  const sources = [
    ...
    {
      name: "Columbian H3 Static Schedule",
