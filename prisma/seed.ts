...
async function main() {
  ...
  const kennels: Array<{
    ...
    {
      shortName: "FHAC-U", fullName: "FHAC-U Hash House Harriers", region: "San Jose, CA",
      website: "https://svh3.com",
    ...
    {
      shortName: "Agnews", fullName: "Agnews State Hash House Harriers", region: "San Jose, CA",
      website: "https://svh3.com",
      scheduleDayOfWeek: "Thursday", scheduleTime: "6:30 PM", scheduleFrequency: "Biweekly",
    ...
    {
      shortName: "VMH3", fullName: "Vine & Malthouse Hash House Harriers", region: "San Francisco, CA",
      scheduleFrequency: "Irregular",
  ...
  const sources = [
    ...
    // Bay Area iCal feed (sfh3.com aggregator — ~11 kennels)
    {
      ...
      kennelShortNames: ["SFH3", "GPH3", "EBH3", "SVH3", "FHAC-U", "Agnews", "BARH3", "MarinH3", "FCH3", "SFFMH3", "VMH3"],
    },
  ];
