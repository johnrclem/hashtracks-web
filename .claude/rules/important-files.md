...
- `src/lib/analytics.ts` — Typed client-side PostHog event capture (`capture()`, `identifyUser()`)
...
- `src/components/admin/AnalyticsDashboard.tsx` — Dashboard UI with recharts (charts, stat cards, tables)
