...
| `source-platform-notes.md` | Self-improving platform memory. Daily run consults + appends. Covers Squarespace, Wix (incl. Wix Events and third-party **Boom Calendar** widgets), WordPress.com, Meetup, Ghost, Google Sites + Sheets, Blogger/Blogspot, Gamma, bespoke static club sites, and Harrier Central. |
