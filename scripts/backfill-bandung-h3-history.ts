 ...
 * data, no parser, per the H7 / Asunción lesson. Each row is shaped exactly
 * like the live adapter's output (title verbatim, location composed from the
 ...
 *
 * Source-data quirks are preserved, NOT "fixed": BHHH2 reuses run# 2292 (two
 * dates), skips 2273 and 2289, and one title says "Run 2231" on event #2301.
 *
